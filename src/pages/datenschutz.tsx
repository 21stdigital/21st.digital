...
const PrivacyPage = () => (
  <div>
    ...
    <main className="px-4 sm:px-12 md:px-18 mx-auto max-w-7xl mb-24">
      ...
      <h2 className="mt-8 text-2xl font-bold">1. Datenschutz auf einen Blick</h2>
      ...
      <h3 className="mt-4 text-xl font-bold">Datenerfassung auf dieser Website</h3>{' '}
      <h4 className="mt-4 text-lg font-bold">Wer ist verantwortlich f&uuml;r die Datenerfassung auf dieser Website?</h4>{' '}
      <p>
      ...
      <h4 className="mt-4 text-lg font-bold">Wie erfassen wir Ihre Daten?</h4>{' '}
      <p>
      ...
      <h4 className="mt-4 text-lg font-bold">Wof&uuml;r nutzen wir Ihre Daten?</h4>{' '}
      <p>
      ...
      <h4 className="mt-4 text-lg font-bold">Welche Rechte haben Sie bez&uuml;glich Ihrer Daten?</h4>{' '}
      <p>
      ...
      <h2 className="mt-8 text-2xl font-bold">3. Allgemeine Hinweise und Pflicht&shy;informationen</h2>
      ...
      <h3 className="mt-4 text-xl font-bold">Hinweis zur verantwortlichen Stelle</h3>{' '}
      <p>Die verantwortliche Stelle f&uuml;r die Datenverarbeitung auf dieser Website ist:</p>{' '}
      <p>
        21st digital GmbH
        <br />
        Oberhafenstra&szlig;e 1<br />
        20097 Hamburg
      </p>
      <p className="mt-2">
        {typeof window !== 'undefined' && <a href="tel:040 361 683 30">Telefon: 040 361 683 30</a>}
        <br />
        {typeof window !== 'undefined' && <a href="mailto:privacy@21st.digital">E-Mail: privacy@21st.digital</a>}
      </p>
      <p className="mt-2">
      ...
      <h3 className="mt-4 text-xl font-bold">Speicherdauer</h3>{' '}
      <p>
      ...
      <h3 className="mt-4 text-xl font-bold">Widerruf Ihrer Einwilligung zur Datenverarbeitung</h3>{' '}
      <p>
      ...
      <h3 className="mt-4 text-xl font-bold">Recht auf Daten&shy;&uuml;bertrag&shy;barkeit</h3>{' '}
      <p>
      ...
      <h3 className="mt-4 text-xl font-bold">SSL- bzw. TLS-Verschl&uuml;sselung</h3>{' '}
      <p>
      ...
      <h3 className="mt-4 text-xl font-bold">Auskunft, L&ouml;schung und Berichtigung</h3>{' '}
      <p>
      ...
      <h3 className="mt-4 text-xl font-bold">Recht auf Einschr&auml;nkung der Verarbeitung</h3>{' '}
      <p>
      ...
      <h2 className="mt-8 text-2xl font-bold">4. Datenerfassung auf dieser Website</h2>
      <h3 className="mt-4 text-xl font-bold">Kontaktformular</h3>{' '}
      <p>
      ...
      <h3 className="mt-4 text-xl font-bold">Anfrage per E-Mail, Telefon oder Telefax</h3>{' '}
      <p>
