...
const Footer = () => (
  <footer className="pt-36 w-full flex flex-col items-center justify-center bg-black">
    <div className="sm:w-2/3 w-full px-4 text-white flex flex-col">
      ...
      <div className="flex mt-8 flex-col md:flex-row md:justify-between items-start">
        <p className="w-full md:w-2/3 text-gray-400">
          Gerne lernen wir Dich und Dein Projekt kennen und sind gespannt, was Du vorhast und wie wir Dir helfen können.
        </p>
